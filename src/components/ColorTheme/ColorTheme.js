        ...
        return (
            <div>
                <div className="ColorBox">
                    ...
                    {this.state.posting && <img className="popupSuccess" src='https://loading.io/spinners/fidget-spinner/lg.fidget-spinner.gif' width="200" alt=''/>}
                    <div className="rainbowContainer"><button id="rainbow" onClick={()=>this.postColor()} disabled={!this.state.buttonOn}>Finalize Your Mood</button></div>
            </div>
